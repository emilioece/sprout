...
def render_schedule(app):
    ...
    for day in range(1, days_in_month + 1):
        ...
        lbl = Label(text=str(day), color=theme.text, font_size="12sp", bold=is_today)
        ...
        if is_today:
            ...
            box = RoundedBox(bg_color=theme.water_highlight, border_color=theme.water_highlight, radius=dp(8))
            box.add_widget(lbl)
            grid.add_widget(box)
        else:
            grid.add_widget(lbl)
    ...
    if events:
        ...
        for day, name in events:
            ...
            row.add_widget(Label(text="\U0001F4A7", size_hint_x=None, width=dp(24), font_size="14sp"))
